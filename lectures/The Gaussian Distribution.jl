...
# ╔═╡ 7f37d8ab-72b3-489d-85dd-80f1fa300df1
...
# ╔═╡ 78e6f787-6e17-4563-b742-75eabd6f2719
...
# ╔═╡ 04f08c9c-6d65-437a-a175-319dea10a418
...
# ╔═╡ 195b5944-c780-4cf4-be93-d7f45c479575
N = 100;

# ╔═╡ a16f64e3-9c48-46f0-b584-a3a96d151c2b
generative_dist = MvNormal([0,1.], [0.8 0.5; 0.5 1.0]);

# ╔═╡ 03518494-8e6b-4b4e-9802-bbe4a17a7010
md"""
Let's generate some observations from our distribution `generative_dist`:
"""

# ╔═╡ a1b1b1b7-9e47-4af5-bb1f-36bacf9f2fa3
D = rand(generative_dist, N)

# ╔═╡ 5b7c4dcf-af52-4041-a300-11f149e2461c
...
# ╔═╡ a5db0520-1b4b-4043-98ba-4a2a84aaca50
md"""
# Appendix
"""
...
manifest_format = "2.0"
project_hash = "9d330ad6f6604a156021dd7121d4281e4d156f71"
