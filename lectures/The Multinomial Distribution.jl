...
md"""
We need a prior for the parameters ``\mu = (\mu_1,\mu_2,\ldots,\mu_K)``. In the [binary coin toss example](https://biaslab.github.io/BMLIP-colorized/lectures/Bayesian%20Machine%20Learning.html#beta-prior), 
