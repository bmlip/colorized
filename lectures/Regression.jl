...
# ╔═╡ 2a69bce1-8d5f-4908-b421-a070d43c5679
md"""
...
Let's generate some observations from this function. You can change the **number of observations** and the **measurement noise**.

"""

# ╔═╡ 3832172d-675c-4bbb-81bf-505eec27bf58
TODO("FOns add plot of data generating process from the mini on regression." )
...
section_outline("Challenge Revisited:", "Finding a Secret Function" , color= "Green" )


# ╔═╡ c0c57aa6-155a-49a9-9ed2-d568de1b5be2
TODO("Fons please solve the Challenge with code from the mini")
...
# ╔═╡ f15b32fd-4883-4af4-afda-209b4bdd4f52
TODO("Fons can you finish this example with a slider for N")
...
using Plots, Distributions, LinearAlgebra, LaTeXStrings
