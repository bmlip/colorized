...
For example, [the product of two independent variables that are both Gaussian-distributed does not lead to a Gaussian distribution](https://biaslab.github.io/BMLIP-colorized/lectures/The%20Gaussian%20Distribution.html#product-of-gaussians).
